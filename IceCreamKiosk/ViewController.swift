...
class ViewController: UIViewController {
    ...
    @IBAction func tempButton(_ sender: Any) {
        ...
        let pervhasedSB = UIStoryboard(name: "PerchasedIceCreamScreen", bundle: .main)
        // Mark:  이동할 스토리보드에 연결된 뷰 컨트롤러를 불러옴
        guard let perchasedVC = pervhasedSB.instantiateViewController(withIdentifier: "perchasedIceCreamViewController") as? PerchasedIceCreamViewController else { return }
        // 화면 전환 애니메이션 설정
